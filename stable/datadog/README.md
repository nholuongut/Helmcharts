...
With upcoming deprecation of `nholuongut/Helmcharts` repository, the Datadog Helm Charts repository has moved to: https://github.com/DataDog/helm-charts
...
**If you don't specify a token, a random one is generated at each deployment so you must use `--recreate-pods` to ensure all pod use the same token.** see[Datadog Chart notes](https://github.com/nholuongut/Helmcharts/blob/57d3030941ad2ec2d6f97c86afdf36666658a884/stable/datadog/templates/NOTES.txt#L49-L59) to learn more.
...
Please follow the [migration guide](https://github.com/nholuongut/Helmcharts/blob/master/stable/datadog/docs/Migration_1.x_to_2.x.md) to update you `values.yaml` file.
...
See [0.18.1's README](https://github.com/nholuongut/Helmcharts/blob/847f737479bb78d89f8fb650db25627558fbe1f0/stable/datadog/README.md) to see which options were supported at the time.
