...
`mongodb.enabled` | Enable or disable MongoDB dependency. Refer to the [stable/mongodb docs](https://github.com/nholuongut/Helmcharts/tree/master/stable/mongodb#configuration) for more information | `true`
