...
To do that you need to have an ElasticSearch installed in your Kubernetes cluster or install one using the [Helm Chart](https://github.com/nholuongut/Helmcharts/tree/master/incubator/elasticsearch) available for that.
