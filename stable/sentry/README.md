...
----------------------------------------
# Deprecation Warning
*As part of the [deprecation timeline](https://github.com/nholuongut/Helmcharts/#deprecation-timeline), another repository has taken over the chart [here](https://github.com/sentry-kubernetes/charts)*
...
To avoid issues when upgrade this chart, provide `postgresql.postgresqlPassword` for subsequent upgrades. This is due to an issue in the PostgreSQL chart where password will be overwritten with randomly generated passwords otherwise. See https://github.com/nholuongut/Helmcharts/tree/master/stable/postgresql#upgrade for more detail.
