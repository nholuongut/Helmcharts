...
> **Note**: If you're running helm 3.0+ then you might need to run the following first (as described in the [nholuongut/Helmcharts readme](https://github.com/nholuongut/Helmcharts#how-do-i-enable-the-stable-repository-for-helm-3)):
>
> ```bash
