...
[CoreDNS dashboard](https://github.com/nholuongut/Helmcharts/blob/master/stable/prometheus-operator/templates/grafana/dashboards-1.14/k8s-coredns.yaml) is the only dashboard which is maintained in this repo and can be changed without import.
