...
- [node-exporter](https://github.com/nholuongut/Helmcharts/tree/master/stable/prometheus-node-exporter)
- [kube-state-metrics](https://github.com/nholuongut/Helmcharts/tree/master/stable/kube-state-metrics)
- [grafana](https://github.com/nholuongut/Helmcharts/tree/master/stable/grafana)
...
For a full list of configurable values please refer to the [Grafana chart](https://github.com/nholuongut/Helmcharts/tree/master/stable/grafana#configuration).
...
- [Grafana](https://github.com/nholuongut/Helmcharts/tree/master/stable/grafana#grafana-helm-chart)
...
You can check out the tickets for this change [here](https://github.com/coreos/prometheus-operator/issues/592) and [here](https://github.com/nholuongut/Helmcharts/pull/6765).

## High-level overview of Changes
The chart has 3 dependencies, that can be seen in the chart's requirements file:
https://github.com/nholuongut/Helmcharts/blob/master/stable/prometheus-operator/requirements.yaml
...
### Grafana
The Grafana chart is more feature-rich than this chart - it contains a sidecar that is able to load data sources and dashboards from configmaps deployed into the same cluster. For more information check out the [documentation for the chart](https://github.com/nholuongut/Helmcharts/tree/master/stable/grafana)
