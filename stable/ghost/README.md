...
Given the [`stable` deprecation timeline](https://github.com/nholuongut/Helmcharts#deprecation-timeline), the Bitnami maintained Ghost Helm chart is now located at [bitnami/charts](https://github.com/bitnami/charts/).
...
In https://github.com/nholuongut/Helmcharts/pulls/17297 the `apiVersion` of the deployment resources was updated to `apps/v1` in tune with the api's deprecated, resulting in compatibility breakage.
