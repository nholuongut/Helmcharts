...
Fixed an issue where the JCasC won't run if JCasC auto-reload is enabled [issue #17135](https://github.com/nholuongut/Helmcharts/issues/17135)

## 1.7.4

Comments out JCasC example of jenkins.systemMessage so that it can be used by end users. Previously, an attempt to set systemMessage causes Jenkins to startup, citing duplicate JCasC settings for systemMessage [issue #13333](https://github.com/nholuongut/Helmcharts/issues/13333)
...
Update the default requirements for jenkins-slave to 512Mi which fixes frequently encountered [issue #3723](https://github.com/nholuongut/Helmcharts/issues/3723)
