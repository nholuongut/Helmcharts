...
added, causing any subsequent upgrade to fail. See https://github.com/nholuongut/Helmcharts/issues/7726.

It also fixes https://github.com/nholuongut/Helmcharts/issues/7726 where a deployment `extensions/v1beta1` can not be upgraded if `spec.selector` is not explicitly set.

Finally, it fixes https://github.com/nholuongut/Helmcharts/issues/7803 by removing mutable labels in `spec.VolumeClaimTemplate.metadata.labels` so that it is upgradable.
