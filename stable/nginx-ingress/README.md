...
else it would make it impossible to evacuate a node. See [gh issue #7127](https://github.com/nholuongut/Helmcharts/issues/7127) for more info.
...
Detail of how and why are in [this issue](https://github.com/nholuongut/Helmcharts/pull/13646) but to resolve this you can set `xxxx.service.omitClusterIP` to `true` where `xxxx` is the service referenced in the error.
