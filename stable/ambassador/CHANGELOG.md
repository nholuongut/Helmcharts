...
- Ambassador Pro will pick up when `AMBASSADOR_ID` is set in `.Values.env` [[#15025]](https://github.com/nholuongut/Helmcharts/issues/15025).
...
- Add support for Ambassador PRO [see readme](https://github.com/nholuongut/Helmcharts/blob/master/stable/ambassador/README.md#ambassador-pro)
...
- First release of Ambassador Helm Chart in nholuongut/Helmcharts
- For migration see [Migrating from datawire/ambassador chart](https://github.com/nholuongut/Helmcharts/tree/master/stable/ambassador#migrating-from-datawireambassador-chart-chart-version-0400-or-0500)
