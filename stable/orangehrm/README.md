...
Given the [`stable` deprecation timeline](https://github.com/nholuongut/Helmcharts#deprecation-timeline), the Bitnami maintained OrangeHRM Helm chart is now located at [bitnami/charts](https://github.com/bitnami/charts/).
