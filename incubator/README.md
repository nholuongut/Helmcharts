...
⚠️ Note the [status of the project](https://github.com/nholuongut/Helmcharts/blob/master/README.md#status-of-the-project), [deprecation timeline](https://github.com/nholuongut/Helmcharts/blob/master/README.md#deprecation-timeline), and the ongoing effort to [relocate charts to new repos](https://github.com/nholuongut/Helmcharts/issues/21103).

<!-- Keep full URL links to repo files because this README syncs from master to gh-pages.  -->
We'd love to have you contribute! Please refer to our [contribution guidelines](https://github.com/nholuongut/Helmcharts/blob/master/CONTRIBUTING.md) for details.

## License

<!-- Keep full URL links to repo files because this README syncs from master to gh-pages.  -->
[Apache 2.0 License](https://github.com/nholuongut/Helmcharts/blob/master/LICENSE).
